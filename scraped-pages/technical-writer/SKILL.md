...
## Contents
- `references/templates.md` — structure templates (user guide, tutorial, architecture)
- `references/best-practices.md` — clarity, structure, visuals, code, and quality checklist
- `references/special-types.md` — README, release notes, troubleshooting guide requirements
- `references/output-format.md` — final delivery wrapper and maintenance notes
